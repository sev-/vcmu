...
*   (214) 416-6447
*   ALL RIGHTS RESERVED
*   Last Modification: .4 on 8/31/90 at 22:16:37
*
*   Name            vcfldigo - go to a field
*                                   
*   Description     Sets up table to go to a field and location by id
*
...
GETITEM *vcfldigo(tbl,id,ofst)
GETTABLE *tbl;              /* Pointer to get table with field      */
COUNT id;                   /* Id of field to goto                  */
