...
*   (214) 416-6447
*   ALL RIGHTS RESERVED
*   Last Modification: .4 on 8/31/90 at 22:16:36
*
*   Name            vcfldiget - get field by id
*                                   
*   Description     Gets a field from a gettable by field id
*
...
TEXT *vcfldiget(tbl,id,flag)
GETTABLE *tbl;              /* Pointer to get table with field      */
COUNT id;                   /* Id of field to get                   */
