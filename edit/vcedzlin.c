...
*   (214) 416-6447
*   ALL RIGHTS RESERVED
*   Last Modification: .4 on 8/31/90 at 21:52:11
*
*   Name            vcedzlin.c - clear line
*                                   
*   Description     Low level function that removes line from 
*                   cashe manager
*
...
COUNT vcedzline(edbuf,lptr,addr)
...
DBDP addr;                  /* Address of current line              */
    ...
    if(lptr != (DBDP)0)                 /* If valid line            */
        ...
        dbmscmgr(edbuf->bfdnum,&cdbdp,DBMSFREE);  /* Free address   */
